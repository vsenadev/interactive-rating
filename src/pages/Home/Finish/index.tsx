...
export default function Finish(props: IFinish){
    return(
        <div className={styles.container__box}>
            ...
            <h1 className={styles.container__box_title}>Thank you!</h1>
            <p className={styles.container__box_text}>We appreciate you taking the time to give a rating. If you ever need more support, don't hesitate to get in touch!</p>
        </div>
    )
}